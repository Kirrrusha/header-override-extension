...
function RequestHeadersApp(props) {
  ...
  function editHeader(id, name, value) {
...
console.log('headers', headers);
  ...
  function addHeader(name, value) {
    ...
    const newHeader = { id: generateRandomInteger(MAX_HEADER_ID), name, value, enabled: false };
  ...
  return (
    <div className="request-header-app stack-small">
      ...
      <button type="button" className="btn btn__primary btn__lg" onClick={() => addHeader('', '')}>
        Add
      </button>
    </div>
  );
